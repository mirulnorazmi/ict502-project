			...
			<div class="grid gap-1">
			  <div class="p-2 g-col-6">
				 ...
				 <input name="name" type="text" class="form-control"
							id="exampleFormControlInput1" value="<c:out value='${employee.name }' />">
			  </div>
			  <div class="p-2 g-col-6">
			  ...
			  <div class="p-2 g-col-6">
				 ...
				 <input name="phone" type="text" class="form-control"
							id="exampleFormControlInput1" value="<c:out value='${employee.phone }' />">
			  </div> 
			  <div class="p-2 g-col-6 d-flex flex-row justify-content-between">
				  <div class="col-6" style="padding: 0 10px 0 0">
				  	...
				  	<input name="age" type="text" class="form-control"
								id="exampleFormControlInput1" value="<c:out value='${employee.age }' />">
				  </div>    
			  ...
			  <div
				  ...
				  <div class="col-6" style="padding: 0 10px 0 0">
					...
					<input name="startDate" type="date" class="form-control" id="minDate"
								id="exampleFormControlInput1" value="<c:out value='${employee.startdate }' />">
				  </div>
				  <div class="col-6" style="padding: 0 10px 0 0">
				  	<label for="exampleFormControlInput1" class="form-label">End date</label>
					<input name="endDate" type="date" class="form-control" id="minDate"
								id="exampleFormControlInput1" value="<c:out value='${employee.enddate }' />">
				  </div>
			  </div>
			  <div
						class="p-2 g-col-6  mt-2 d-flex flex-row justify-content-between">
				  <div class="col-6" style="padding: 0 10px 0 0">
				  	...
				  	<div class="input-group">
						...
						<input name="hourlyRate" type="number" class="form-control"
									id="exampleFormControlInput1" value="<c:out value='${employee.hourlyrate }' />">
					</div>
				  </div>
				  <!-- <div class="col-6" style="padding: 0 10px 0 0">
